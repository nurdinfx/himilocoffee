    ...
    <div className="min-h-screen relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
        <div className="text-center">
            ...
            >
                Taste the extraordinary. Sign in to continue.
            </motion.p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          >
            New here? <Link to="/register" className="font-black text-primary-400 hover:text-primary-300 transition-colors">Join the family</Link>
          </motion.p>
        </form>
      </motion.div>
    </div>
